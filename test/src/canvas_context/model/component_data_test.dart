...
void main() {
  group('Component data tests', () {
    test(
      ...
      componentData.addConnection(ConnectionIn(otherComponentId: 'componentId1', connectionId: 'connectionId1'));
      componentData.addConnection(ConnectionIn(otherComponentId: 'componentId2', connectionId: 'connectionId2'));
