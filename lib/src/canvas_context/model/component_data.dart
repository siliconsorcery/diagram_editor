...
class ComponentData with ChangeNotifier {
  ...
  ComponentData.fromJson(
    ...
    childrenIds.addAll((json['children_ids'] as List).map((id) => id as String).toList());
    connections.addAll((json['connections'] as List).map((connectionJson) => Connection.fromJson(connectionJson)));
  }
