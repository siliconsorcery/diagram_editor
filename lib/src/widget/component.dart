              ...
              Positioned(
                ...
                child: Container(
                  transform: Matrix4.identity()
                    // Rotate about the center of the component.
                    ..translate(componentData.size.width / 2, componentData.size.height / 2)
                    ..rotateZ(componentData.rotation)
                    ..translate(-componentData.size.width / 2, -componentData.size.height / 2)
                    // Scale from the center of the component.
